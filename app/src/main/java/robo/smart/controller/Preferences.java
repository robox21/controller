...
public class Preferences extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || ConnectivityPreferenceFragment.class.getName().equals(fragmentName);
    }

    /**
     * This fragment shows connectivity preferences
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ConnectivityPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("key_url"));
